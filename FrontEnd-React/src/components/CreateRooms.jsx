...
const CreateRoom = () => {
    ...
    const store = async (e) => {
      e.preventDefault();
      if (validNumber) { 
        await axios.post(endpoint, {number: number,type: type,description: description,cost: cost,availability: availability,
        });
  ...
  return (
    ...
    <div className='card col-sm-6 p-3'>
        ...
        <div className="mb-1 ps-4">
            ...
            <div className='mb-1 ps-4'>
                <label className='col-sm col-form-label'>Cost</label>
                <div class="col-sm-11">
                    <input 
                    value={cost}
