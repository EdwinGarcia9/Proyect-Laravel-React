...
const ShowUsers = () => {
  ...
  return (
    <div className='container'>
          ...
          <Link to="/CreateUser" className='btn btn-primary'>Create</Link>
      ...
      <table className='table table-dark table-striped table-hover'>
        ...
        <tbody>
          { users.map((user) => (
            ...
            <td> {user.rol}</td>
            <td>
                <Link className='btn btn-warning m-1' to={`/EditUser/${user.id}`}><FontAwesomeIcon icon={faPenToSquare} />  </Link>
